...
const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Als Junior Software Engineer (Python, JavaScript, C#) bringe ich eine seltene Kombination aus technischer und kaufmännischer Expertise mit.\nVor meiner Spezialisierung sammelte ich praktische Erfahrung als IT-Systemelektroniker im Außendienst, wo ich lernte, IT-Probleme direkt aus Anwendersicht zu lösen. Ergänzend dazu gab mir meine kaufmännische Ausbildung (SAP Business One) ein tiefes Verständnis für datengestützte Geschäftsprozesse und Materialbeschaffung.\nDiese doppelte Perspektive ermöglicht es mir, Software nicht nur zu entwickeln, sondern sie auch im Hinblick auf den echten Endanwendernutzen und den geschäftlichen Mehrwert zu bewerten.",
